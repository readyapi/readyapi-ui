...
/**
 * @deprecated LegacyToast is deprecated and will be removed in a future version. Not recommended for use. Instead import toast from '@readyapi/ui' and use 'toast.show()'
 */
const legacyToast = {
